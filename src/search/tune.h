...
#define PARAM(name, value, min, max, step) constexpr int name = value
    ...
    PARAM(see_cap_margin, 98, 70, 120, 8);
    PARAM(see_quiet_margin, 98, 70, 120, 8);

    PARAM(fp_base, 161, 120, 180, 10);
    PARAM(fp_mult, 102, 70, 150, 10);

    PARAM(ext_margin, 133, 45, 150, 12);

    PARAM(zws_margin, 82, 60, 90, 8);

    PARAM(hp_margin, 4359, 2500, 5000, 400);
    ...
    PARAM(max_history_bonus, 1584, 1100, 1800, 50);
