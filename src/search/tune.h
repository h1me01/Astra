...
PARAM(lmr_div, 307, 150, 500);
PARAM(lmr_min_moves, 3, 1, 3);

PARAM(static_h_mult, -47, -500, -1);
PARAM(static_h_min, 65, 1, 1000);
PARAM(static_h_max, 273, 1, 1000);
...
PARAM(hp_depth_mult, 6296, 2500, 12500);
PARAM(hp_qdiv, 6886, 1, 16384);
PARAM(hp_cdiv, 4002, 1, 16384);
PARAM(hbonus_margin, 50, 10, 200);
